...
{
HX_STACK_PUSH("IntIter::new","/usr/lib/haxe/std/IntIter.hx",38);
{
	HX_STACK_LINE(39)
	this->min = min;
	HX_STACK_LINE(40)
...
int IntIter_obj::next( ){
	HX_STACK_PUSH("IntIter::next","/usr/lib/haxe/std/IntIter.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_LINE(53)
	return (this->min)++;
}
...
bool IntIter_obj::hasNext( ){
	HX_STACK_PUSH("IntIter::hasNext","/usr/lib/haxe/std/IntIter.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_LINE(46)
