...
{
HX_STACK_PUSH("Timer::new","haxe/Timer.hx",114);
{
	HX_STACK_LINE(116)
	this->mTime = time;
	HX_STACK_LINE(117)
...
{
		HX_STACK_PUSH("Timer::nmeCheck","haxe/Timer.hx",182);
		HX_STACK_THIS(this);
...
Void Timer_obj::stop( ){
{
		HX_STACK_PUSH("Timer::stop","haxe/Timer.hx",140);
		HX_STACK_THIS(this);
		HX_STACK_LINE(140)
		if ((this->mRunning)){
			HX_STACK_LINE(144)
...
Void run(){
{
		HX_STACK_PUSH("Timer::run","haxe/Timer.hx",133);
		HX_STACK_THIS(this);
	}
return null();
}
...
Dynamic Timer_obj::measure( Dynamic f,Dynamic pos){
	HX_STACK_PUSH("Timer::measure","haxe/Timer.hx",124);
	HX_STACK_ARG(f,"f");
...
Float Timer_obj::nmeNextWake( Float limit){
	HX_STACK_PUSH("Timer::nmeNextWake","haxe/Timer.hx",155);
	...
	HX_STACK_LINE(159)
	{
		...
		Array< ::haxe::Timer > _g1 = ::haxe::Timer_obj::sRunningTimers;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(159)
		while(((_g < _g1->length))){
			HX_STACK_LINE(159)
			::haxe::Timer timer = _g1->__get(_g);		HX_STACK_VAR(timer,"timer");
			HX_STACK_LINE(159)
			++(_g);
			HX_STACK_LINE(161)
...
{
		HX_STACK_PUSH("Timer::nmeCheckTimers","haxe/Timer.hx",197);
		HX_STACK_LINE(199)
...
::haxe::Timer Timer_obj::delay( Dynamic f,int time){
	...
	HX_STACK_LINE(220)
	Array< ::haxe::Timer > t = Array_obj< ::haxe::Timer >::__new().Add(::haxe::Timer_obj::__new(time));		HX_STACK_VAR(t,"t");
...
{
	sRunningTimers= Array_obj< ::haxe::Timer >::__new();
	nme_time_stamp= ::neash::Loader_obj::load(HX_CSTRING("nme_time_stamp"),(int)0);
}
