...
{
HX_STACK_PUSH("Bytes::new","/usr/lib/haxe/std/haxe/io/Bytes.hx",32);
{
	HX_STACK_LINE(33)
	this->length = length;
	HX_STACK_LINE(34)
...
Array< unsigned char > Bytes_obj::getData( ){
	HX_STACK_PUSH("Bytes::getData","/usr/lib/haxe/std/haxe/io/Bytes.hx",255);
	HX_STACK_THIS(this);
	HX_STACK_LINE(255)
	return this->b;
}
...
::String Bytes_obj::toHex( ){
	HX_STACK_PUSH("Bytes::toHex","/usr/lib/haxe/std/haxe/io/Bytes.hx",241);
	HX_STACK_THIS(this);
	HX_STACK_LINE(242)
...
::String Bytes_obj::toString( ){
	HX_STACK_PUSH("Bytes::toString","/usr/lib/haxe/std/haxe/io/Bytes.hx",218);
	HX_STACK_THIS(this);
	HX_STACK_LINE(218)
...
::String Bytes_obj::readString( int pos,int len){
	HX_STACK_PUSH("Bytes::readString","/usr/lib/haxe/std/haxe/io/Bytes.hx",168);
	HX_STACK_THIS(this);
...
int Bytes_obj::compare( ::haxe::io::Bytes other){
	HX_STACK_PUSH("Bytes::compare","/usr/lib/haxe/std/haxe/io/Bytes.hx",130);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_PUSH("Bytes::sub","/usr/lib/haxe/std/haxe/io/Bytes.hx",103);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
	HX_STACK_LINE(105)
...
{
		HX_STACK_PUSH("Bytes::blit","/usr/lib/haxe/std/haxe/io/Bytes.hx",71);
		HX_STACK_THIS(this);
		HX_STACK_ARG(pos,"pos");
...
{
		HX_STACK_PUSH("Bytes::set","/usr/lib/haxe/std/haxe/io/Bytes.hx",53);
		HX_STACK_THIS(this);
		HX_STACK_ARG(pos,"pos");
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(53)
...
int Bytes_obj::get( int pos){
	HX_STACK_PUSH("Bytes::get","/usr/lib/haxe/std/haxe/io/Bytes.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_LINE(37)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_PUSH("Bytes::alloc","/usr/lib/haxe/std/haxe/io/Bytes.hx",259);
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_PUSH("Bytes::ofString","/usr/lib/haxe/std/haxe/io/Bytes.hx",291);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(302)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(303)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_PUSH("Bytes::ofData","/usr/lib/haxe/std/haxe/io/Bytes.hx",340);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(340)
