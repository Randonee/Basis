...
Void Lib_obj::close( ){
{
		HX_STACK_PUSH("Lib::close","neash/Lib.hx",47);
		HX_STACK_LINE(48)
...
::String inTitle = __o_inTitle.Default(HX_CSTRING("NME"));
	HX_STACK_PUSH("Lib::create","neash/Lib.hx",53);
	...
	HX_STACK_ARG(inIcon,"inIcon");
{
		...
		Void run(Dynamic inFrameHandle){
			HX_STACK_PUSH("*::_Function_1_1","neash/Lib.hx",64);
...
::neash::display::ManagedStage Lib_obj::createManagedStage( int inWidth,int inHeight){
	HX_STACK_PUSH("Lib::createManagedStage","neash/Lib.hx",82);
	HX_STACK_ARG(inWidth,"inWidth");
	HX_STACK_ARG(inHeight,"inHeight");
	HX_STACK_LINE(83)
	...
	HX_STACK_LINE(85)
	::neash::display::ManagedStage result = ::neash::display::ManagedStage_obj::__new(inWidth,inHeight);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(86)
...
Void Lib_obj::exit( ){
{
		HX_STACK_PUSH("Lib::exit","neash/Lib.hx",92);
		HX_STACK_LINE(93)
...
{
		HX_STACK_PUSH("Lib::forceClose","neash/Lib.hx",108);
		HX_STACK_LINE(110)
...
int Lib_obj::getTimer( ){
	HX_STACK_PUSH("Lib::getTimer","neash/Lib.hx",116);
	HX_STACK_LINE(116)
...
{
		HX_STACK_PUSH("Lib::getURL","neash/Lib.hx",123);
...
{
		HX_STACK_PUSH("Lib::nmeSetCurrentStage","neash/Lib.hx",132);
...
Void Lib_obj::pause( ){
{
		HX_STACK_PUSH("Lib::pause","neash/Lib.hx",138);
		HX_STACK_LINE(138)
...
{
		HX_STACK_PUSH("Lib::postUICallback","neash/Lib.hx",144);
...
Void Lib_obj::resume( ){
{
		HX_STACK_PUSH("Lib::resume","neash/Lib.hx",156);
		HX_STACK_LINE(156)
...
{
		HX_STACK_PUSH("Lib::setIcon","neash/Lib.hx",169);
...
{
		HX_STACK_PUSH("Lib::setPackage","neash/Lib.hx",176);
...
::neash::display::MovieClip Lib_obj::nmeGetCurrent( ){
	HX_STACK_PUSH("Lib::nmeGetCurrent","neash/Lib.hx",188);
	HX_STACK_LINE(189)
	if (((::neash::Lib_obj::nmeCurrent == null()))){
		HX_STACK_LINE(191)
...
::neash::display::Stage Lib_obj::nmeGetStage( ){
	HX_STACK_PUSH("Lib::nmeGetStage","neash/Lib.hx",200);
	HX_STACK_LINE(201)
	if (((::neash::Lib_obj::nmeStage == null()))){
		HX_STACK_LINE(202)
