...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_PUSH("Type::getClass","/usr/lib/haxe/std/cpp/_std/Type.hx",39);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(40)
...
::Enum Type_obj::getEnum( Dynamic o){
	HX_STACK_PUSH("Type::getEnum","/usr/lib/haxe/std/cpp/_std/Type.hx",50);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(51)
	if (((o == null()))){
		HX_STACK_LINE(51)
...
::Class Type_obj::getSuperClass( ::Class c){
	HX_STACK_PUSH("Type::getSuperClass","/usr/lib/haxe/std/cpp/_std/Type.hx",56);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(56)
	return c->GetSuper();
}
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_PUSH("Type::getClassName","/usr/lib/haxe/std/cpp/_std/Type.hx",60);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(61)
	if (((c == null()))){
		HX_STACK_LINE(62)
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_PUSH("Type::getEnumName","/usr/lib/haxe/std/cpp/_std/Type.hx",66);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(66)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_PUSH("Type::resolveClass","/usr/lib/haxe/std/cpp/_std/Type.hx",70);
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_PUSH("Type::resolveEnum","/usr/lib/haxe/std/cpp/_std/Type.hx",77);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(78)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(79)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_PUSH("Type::createInstance","/usr/lib/haxe/std/cpp/_std/Type.hx",84);
	HX_STACK_ARG(cl,"cl");
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_PUSH("Type::createEmptyInstance","/usr/lib/haxe/std/cpp/_std/Type.hx",90);
	HX_STACK_ARG(cl,"cl");
	HX_STACK_LINE(90)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_PUSH("Type::createEnum","/usr/lib/haxe/std/cpp/_std/Type.hx",94);
	HX_STACK_ARG(e,"e");
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_PUSH("Type::createEnumIndex","/usr/lib/haxe/std/cpp/_std/Type.hx",100);
	HX_STACK_ARG(e,"e");
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_PUSH("Type::getInstanceFields","/usr/lib/haxe/std/cpp/_std/Type.hx",106);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(106)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_PUSH("Type::getClassFields","/usr/lib/haxe/std/cpp/_std/Type.hx",110);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(110)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_PUSH("Type::getEnumConstructs","/usr/lib/haxe/std/cpp/_std/Type.hx",114);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(114)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_PUSH("Type::typeof","/usr/lib/haxe/std/cpp/_std/Type.hx",118);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(119)
	if (((v == null()))){
		HX_STACK_LINE(119)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	HX_STACK_PUSH("Type::enumEq","/usr/lib/haxe/std/cpp/_std/Type.hx",134);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(134)
	return (a == b);
...
::String Type_obj::enumConstructor( Dynamic e){
	HX_STACK_PUSH("Type::enumConstructor","/usr/lib/haxe/std/cpp/_std/Type.hx",138);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(138)
	return e->__Tag();
}
...
Dynamic Type_obj::enumParameters( Dynamic e){
	HX_STACK_PUSH("Type::enumParameters","/usr/lib/haxe/std/cpp/_std/Type.hx",142);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(143)
...
int Type_obj::enumIndex( Dynamic e){
	HX_STACK_PUSH("Type::enumIndex","/usr/lib/haxe/std/cpp/_std/Type.hx",147);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(147)
	return e->__Index();
}
...
Dynamic Type_obj::allEnums( ::Enum e){
	HX_STACK_PUSH("Type::allEnums","/usr/lib/haxe/std/cpp/_std/Type.hx",151);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(152)
