...
{
HX_STACK_PUSH("Event::new","neash/events/Event.hx",53);
...
::String Event_obj::nmeGetType( ){
	HX_STACK_PUSH("Event::nmeGetType","neash/events/Event.hx",122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(122)
	return this->_type;
}
...
Dynamic Event_obj::nmeSetTarget( Dynamic v){
	HX_STACK_PUSH("Event::nmeSetTarget","neash/events/Event.hx",121);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(121)
	this->_target = v;
...
Dynamic Event_obj::nmeGetTarget( ){
	HX_STACK_PUSH("Event::nmeGetTarget","neash/events/Event.hx",120);
	HX_STACK_THIS(this);
	HX_STACK_LINE(120)
	return this->_target;
}
...
int Event_obj::nmeGetEventPhase( ){
	HX_STACK_PUSH("Event::nmeGetEventPhase","neash/events/Event.hx",119);
	HX_STACK_THIS(this);
	HX_STACK_LINE(119)
...
Dynamic Event_obj::nmeSetCurrentTarget( Dynamic v){
	HX_STACK_PUSH("Event::nmeSetCurrentTarget","neash/events/Event.hx",118);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(118)
...
Dynamic Event_obj::nmeGetCurrentTarget( ){
	HX_STACK_PUSH("Event::nmeGetCurrentTarget","neash/events/Event.hx",117);
	HX_STACK_THIS(this);
	HX_STACK_LINE(117)
...
bool Event_obj::nmeGetCancelable( ){
	HX_STACK_PUSH("Event::nmeGetCancelable","neash/events/Event.hx",116);
	HX_STACK_THIS(this);
	HX_STACK_LINE(116)
...
bool Event_obj::nmeGetBubbles( ){
	HX_STACK_PUSH("Event::nmeGetBubbles","neash/events/Event.hx",115);
	HX_STACK_THIS(this);
	HX_STACK_LINE(115)
...
::String Event_obj::toString( ){
	HX_STACK_PUSH("Event::toString","neash/events/Event.hx",105);
	HX_STACK_THIS(this);
	HX_STACK_LINE(105)
...
{
		HX_STACK_PUSH("Event::stopPropagation","neash/events/Event.hx",98);
		HX_STACK_THIS(this);
		HX_STACK_LINE(98)
...
{
		HX_STACK_PUSH("Event::stopImmediatePropagation","neash/events/Event.hx",91);
		HX_STACK_THIS(this);
		HX_STACK_LINE(91)
		if ((this->nmeGetCancelable())){
			HX_STACK_LINE(93)
...
{
		HX_STACK_PUSH("Event::nmeSetPhase","neash/events/Event.hx",84);
		HX_STACK_THIS(this);
...
bool Event_obj::nmeGetIsCancelledNow( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelledNow","neash/events/Event.hx",78);
	HX_STACK_THIS(this);
	HX_STACK_LINE(78)
...
bool Event_obj::nmeGetIsCancelled( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelled","neash/events/Event.hx",72);
	HX_STACK_THIS(this);
	HX_STACK_LINE(72)
...
::neash::events::Event Event_obj::clone( ){
	HX_STACK_PUSH("Event::clone","neash/events/Event.hx",66);
	HX_STACK_THIS(this);
	HX_STACK_LINE(66)
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Event_obj::GOT_INPUT_FOCUS,"GOT_INPUT_FOCUS");
	HX_VISIT_MEMBER_NAME(Event_obj::ID3,"ID3");
	HX_VISIT_MEMBER_NAME(Event_obj::INIT,"INIT");
	HX_VISIT_MEMBER_NAME(Event_obj::LOST_INPUT_FOCUS,"LOST_INPUT_FOCUS");
...
void Event_obj::__boot()
{
	...
	GOT_INPUT_FOCUS= HX_CSTRING("gotInputFocus");
	ID3= HX_CSTRING("id3");
	INIT= HX_CSTRING("init");
	LOST_INPUT_FOCUS= HX_CSTRING("lostInputFocus");
