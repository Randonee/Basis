...
Void Stage_obj::nmeOnTouch( Dynamic inEvent,::String inType,::neash::display::TouchInfo touchInfo){
{
		...
		if (((stack->length > (int)0))){
			...
			HX_STACK_LINE(618)
			::neash::events::TouchEvent evt = ::neash::events::TouchEvent_obj::nmeCreate(inType,inEvent,local,obj1);		HX_STACK_VAR(evt,"evt");
			HX_STACK_LINE(619)
			...
			HX_STACK_LINE(636)
			::neash::events::TouchEvent evt = ::neash::events::TouchEvent_obj::nmeCreate(inType,inEvent,::neash::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)),null());		HX_STACK_VAR(evt,"evt");
			HX_STACK_LINE(637)
			evt->touchPointID = inEvent->__Field(HX_CSTRING("value"),true);
			HX_STACK_LINE(638)
			evt->isPrimaryTouchPoint = (((int(inEvent->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0);
...
Float Stage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	switch( (int)(type)){
		...
		case (int)22: {
			HX_STACK_LINE(319)
			::neash::events::Event evt = ::neash::events::Event_obj::__new(::neash::events::Event_obj::GOT_INPUT_FOCUS,null(),null());		HX_STACK_VAR(evt,"evt");
			HX_STACK_LINE(320)
			this->nmeBroadcast(evt);
		}
		;break;
		case (int)23: {
			HX_STACK_LINE(323)
			::neash::events::Event evt = ::neash::events::Event_obj::__new(::neash::events::Event_obj::LOST_INPUT_FOCUS,null(),null());		HX_STACK_VAR(evt,"evt");
			HX_STACK_LINE(324)
			this->nmeBroadcast(evt);
		}
		;break;
