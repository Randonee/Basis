...
Void TouchEvent_obj::__construct(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< Float >  __o_in_localX,hx::Null< Float >  __o_in_localY,::neash::display::InteractiveObject in_relatedObject,hx::Null< bool >  __o_in_ctrlKey,hx::Null< bool >  __o_in_altKey,hx::Null< bool >  __o_in_shiftKey,hx::Null< bool >  __o_in_buttonDown,hx::Null< int >  __o_in_delta,hx::Null< bool >  __o_in_commandKey,hx::Null< int >  __o_in_clickCount)
{
HX_STACK_PUSH("TouchEvent::new","neash/events/TouchEvent.hx",25);
...
::neash::events::MouseEvent TouchEvent_obj::nmeCreateSimilar( ::String inType,::neash::display::InteractiveObject related,::neash::display::InteractiveObject targ){
	HX_STACK_PUSH("TouchEvent::nmeCreateSimilar","neash/events/TouchEvent.hx",44);
	HX_STACK_THIS(this);
...
::neash::events::TouchEvent TouchEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget){
	HX_STACK_PUSH("TouchEvent::nmeCreate","neash/events/TouchEvent.hx",33);
	HX_STACK_ARG(inType,"inType");
	...
	HX_STACK_LINE(35)
	::neash::events::TouchEvent evt = ::neash::events::TouchEvent_obj::__new(inType,true,false,inLocal->x,inLocal->y,null(),(((int(flags) & int(::neash::events::MouseEvent_obj::efCtrlDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efAltDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efShiftDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efLeftDown))) != (int)0),(int)0,null(),(int)0);		HX_STACK_VAR(evt,"evt");
	HX_STACK_LINE(36)
