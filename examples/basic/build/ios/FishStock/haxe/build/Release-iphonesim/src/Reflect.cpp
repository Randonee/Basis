...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::hasField","/usr/lib/haxe/std/cpp/_std/Reflect.hx",29);
	HX_STACK_ARG(o,"o");
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::field","/usr/lib/haxe/std/cpp/_std/Reflect.hx",33);
	HX_STACK_ARG(o,"o");
	HX_STACK_ARG(field,"field");
	HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("Reflect::setField","/usr/lib/haxe/std/cpp/_std/Reflect.hx",37);
		HX_STACK_ARG(o,"o");
		HX_STACK_ARG(field,"field");
...
Dynamic Reflect_obj::getProperty( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::getProperty","/usr/lib/haxe/std/cpp/_std/Reflect.hx",42);
	HX_STACK_ARG(o,"o");
	HX_STACK_ARG(field,"field");
	HX_STACK_LINE(42)
...
{
		HX_STACK_PUSH("Reflect::setProperty","/usr/lib/haxe/std/cpp/_std/Reflect.hx",46);
		HX_STACK_ARG(o,"o");
		HX_STACK_ARG(field,"field");
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(46)
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_PUSH("Reflect::callMethod","/usr/lib/haxe/std/cpp/_std/Reflect.hx",51);
	HX_STACK_ARG(o,"o");
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_PUSH("Reflect::fields","/usr/lib/haxe/std/cpp/_std/Reflect.hx",58);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(59)
	if (((o == null()))){
		HX_STACK_LINE(59)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_PUSH("Reflect::isFunction","/usr/lib/haxe/std/cpp/_std/Reflect.hx",65);
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(65)
...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	HX_STACK_PUSH("Reflect::compare","/usr/lib/haxe/std/cpp/_std/Reflect.hx",69);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(69)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_PUSH("Reflect::compareMethods","/usr/lib/haxe/std/cpp/_std/Reflect.hx",73);
	HX_STACK_ARG(f1,"f1");
	HX_STACK_ARG(f2,"f2");
	HX_STACK_LINE(74)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_PUSH("Reflect::isObject","/usr/lib/haxe/std/cpp/_std/Reflect.hx",81);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(82)
	if (((v == null()))){
		HX_STACK_LINE(82)
...
bool Reflect_obj::deleteField( Dynamic o,::String f){
	HX_STACK_PUSH("Reflect::deleteField","/usr/lib/haxe/std/cpp/_std/Reflect.hx",88);
	HX_STACK_ARG(o,"o");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(89)
	if (((o == null()))){
...
Dynamic Reflect_obj::copy( Dynamic o){
	HX_STACK_PUSH("Reflect::copy","/usr/lib/haxe/std/cpp/_std/Reflect.hx",93);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(94)
	if (((o == null()))){
		HX_STACK_LINE(94)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/Reflect.hx",98);
			{
