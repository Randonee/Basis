...
{
HX_STACK_PUSH("IntHash::new","/usr/lib/haxe/std/cpp/_std/IntHash.hx",30);
{
	HX_STACK_LINE(30)
...
::String IntHash_obj::toString( ){
	HX_STACK_PUSH("IntHash::toString","/usr/lib/haxe/std/cpp/_std/IntHash.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_LINE(61)
...
Dynamic IntHash_obj::iterator( ){
	HX_STACK_PUSH("IntHash::iterator","/usr/lib/haxe/std/cpp/_std/IntHash.hx",55);
	HX_STACK_THIS(this);
	HX_STACK_LINE(56)
...
Dynamic IntHash_obj::keys( ){
	HX_STACK_PUSH("IntHash::keys","/usr/lib/haxe/std/cpp/_std/IntHash.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
...
bool IntHash_obj::remove( int key){
	HX_STACK_PUSH("IntHash::remove","/usr/lib/haxe/std/cpp/_std/IntHash.hx",46);
	HX_STACK_THIS(this);
...
bool IntHash_obj::exists( int key){
	HX_STACK_PUSH("IntHash::exists","/usr/lib/haxe/std/cpp/_std/IntHash.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(42)
...
Dynamic IntHash_obj::get( int key){
	HX_STACK_PUSH("IntHash::get","/usr/lib/haxe/std/cpp/_std/IntHash.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(38)
...
{
		HX_STACK_PUSH("IntHash::set","/usr/lib/haxe/std/cpp/_std/IntHash.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
