...
{
HX_STACK_PUSH("BytesBuffer::new","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",45);
{
	HX_STACK_LINE(45)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_PUSH("BytesBuffer::getBytes","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(142)
...
{
		HX_STACK_PUSH("BytesBuffer::addBytes","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",100);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BytesBuffer::add","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_ARG(src,"src");
		HX_STACK_LINE(93)
		Array< unsigned char > b1 = this->b;		HX_STACK_VAR(b1,"b1");
...
{
		HX_STACK_PUSH("BytesBuffer::addByte","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",63);
		HX_STACK_THIS(this);
