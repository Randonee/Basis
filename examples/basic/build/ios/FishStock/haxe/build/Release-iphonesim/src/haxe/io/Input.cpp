...
::String Input_obj::readString( int len){
	HX_STACK_PUSH("Input::readString","/usr/lib/haxe/std/haxe/io/Input.hx",408);
	HX_STACK_THIS(this);
...
::cpp::CppInt32__ Input_obj::readInt32( ){
	HX_STACK_PUSH("Input::readInt32","/usr/lib/haxe/std/haxe/io/Input.hx",393);
	HX_STACK_THIS(this);
	HX_STACK_LINE(394)
...
int Input_obj::readUInt30( ){
	HX_STACK_PUSH("Input::readUInt30","/usr/lib/haxe/std/haxe/io/Input.hx",384);
	HX_STACK_THIS(this);
	HX_STACK_LINE(385)
	int ch1 = this->readByte();		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(386)
...
int Input_obj::readInt31( ){
	HX_STACK_PUSH("Input::readInt31","/usr/lib/haxe/std/haxe/io/Input.hx",367);
	HX_STACK_THIS(this);
	HX_STACK_LINE(368)
...
int Input_obj::readUInt24( ){
	HX_STACK_PUSH("Input::readUInt24","/usr/lib/haxe/std/haxe/io/Input.hx",360);
	HX_STACK_THIS(this);
	HX_STACK_LINE(361)
	int ch1 = this->readByte();		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(362)
...
int Input_obj::readInt24( ){
	HX_STACK_PUSH("Input::readInt24","/usr/lib/haxe/std/haxe/io/Input.hx",350);
	HX_STACK_THIS(this);
	HX_STACK_LINE(351)
	int ch1 = this->readByte();		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(352)
...
int Input_obj::readUInt16( ){
	HX_STACK_PUSH("Input::readUInt16","/usr/lib/haxe/std/haxe/io/Input.hx",344);
	HX_STACK_THIS(this);
	HX_STACK_LINE(345)
	int ch1 = this->readByte();		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(346)
...
int Input_obj::readInt16( ){
	HX_STACK_PUSH("Input::readInt16","/usr/lib/haxe/std/haxe/io/Input.hx",335);
	HX_STACK_THIS(this);
	HX_STACK_LINE(336)
	int ch1 = this->readByte();		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(337)
...
int Input_obj::readInt8( ){
	HX_STACK_PUSH("Input::readInt8","/usr/lib/haxe/std/haxe/io/Input.hx",328);
	HX_STACK_THIS(this);
	HX_STACK_LINE(329)
...
Float Input_obj::readDouble( ){
	HX_STACK_PUSH("Input::readDouble","/usr/lib/haxe/std/haxe/io/Input.hx",255);
	HX_STACK_THIS(this);
	HX_STACK_LINE(255)
...
Float Input_obj::readFloat( ){
	HX_STACK_PUSH("Input::readFloat","/usr/lib/haxe/std/haxe/io/Input.hx",201);
	HX_STACK_THIS(this);
	HX_STACK_LINE(201)
...
::String Input_obj::readLine( ){
	HX_STACK_PUSH("Input::readLine","/usr/lib/haxe/std/haxe/io/Input.hx",184);
	HX_STACK_THIS(this);
	HX_STACK_LINE(185)
...
::String Input_obj::readUntil( int end){
	HX_STACK_PUSH("Input::readUntil","/usr/lib/haxe/std/haxe/io/Input.hx",176);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Input_obj::read( int nbytes){
	HX_STACK_PUSH("Input::read","/usr/lib/haxe/std/haxe/io/Input.hx",164);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Input::readFullBytes","/usr/lib/haxe/std/haxe/io/Input.hx",156);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
::haxe::io::Bytes Input_obj::readAll( Dynamic bufsize){
	HX_STACK_PUSH("Input::readAll","/usr/lib/haxe/std/haxe/io/Input.hx",80);
	HX_STACK_THIS(this);
...
bool Input_obj::setEndian( bool b){
	HX_STACK_PUSH("Input::setEndian","/usr/lib/haxe/std/haxe/io/Input.hx",73);
	HX_STACK_THIS(this);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(74)
	this->bigEndian = b;
...
{
		HX_STACK_PUSH("Input::close","/usr/lib/haxe/std/haxe/io/Input.hx",70);
		HX_STACK_THIS(this);
	}
return null();
}
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_PUSH("Input::readBytes","/usr/lib/haxe/std/haxe/io/Input.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
...
int Input_obj::readByte( ){
	HX_STACK_PUSH("Input::readByte","/usr/lib/haxe/std/haxe/io/Input.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_LINE(42)
