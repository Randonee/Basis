...
::neash::media::SoundTransform SoundChannel_obj::nmeSetTransform( ::neash::media::SoundTransform inTransform){
	HX_STACK_PUSH("SoundChannel::nmeSetTransform","neash/media/SoundChannel.hx",137);
	HX_STACK_THIS(this);
...
::neash::media::SoundTransform SoundChannel_obj::nmeGetTransform( ){
	HX_STACK_PUSH("SoundChannel::nmeGetTransform","neash/media/SoundChannel.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(127)
...
Float SoundChannel_obj::nmeGetPosition( ){
	HX_STACK_PUSH("SoundChannel::nmeGetPosition","neash/media/SoundChannel.hx",122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(122)
...
Float SoundChannel_obj::nmeGetRight( ){
	HX_STACK_PUSH("SoundChannel::nmeGetRight","neash/media/SoundChannel.hx",121);
	HX_STACK_THIS(this);
	HX_STACK_LINE(121)
...
Float SoundChannel_obj::nmeGetLeft( ){
	HX_STACK_PUSH("SoundChannel::nmeGetLeft","neash/media/SoundChannel.hx",120);
	HX_STACK_THIS(this);
	HX_STACK_LINE(120)
...
{
		HX_STACK_PUSH("SoundChannel::stop","neash/media/SoundChannel.hx",110);
		HX_STACK_THIS(this);
		HX_STACK_LINE(110)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	HX_STACK_PUSH("SoundChannel::nmeCheckComplete","neash/media/SoundChannel.hx",57);
	HX_STACK_THIS(this);
	HX_STACK_LINE(58)
	if (((this->nmeHandle != null()))){
		HX_STACK_LINE(60)
...
::neash::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic inSoundHandle,::neash::media::SoundTransform sndTransform,::neash::events::EventDispatcher dataProvider){
	HX_STACK_PUSH("SoundChannel::createDynamic","neash/media/SoundChannel.hx",44);
...
bool SoundChannel_obj::nmeCompletePending( ){
	HX_STACK_PUSH("SoundChannel::nmeCompletePending","neash/media/SoundChannel.hx",85);
	HX_STACK_LINE(85)
...
{
		HX_STACK_PUSH("SoundChannel::nmePollComplete","neash/media/SoundChannel.hx",91);
		HX_STACK_LINE(91)
