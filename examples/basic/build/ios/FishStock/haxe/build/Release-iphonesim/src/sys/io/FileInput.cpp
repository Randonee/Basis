...
{
HX_STACK_PUSH("FileInput::new","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",33);
{
	HX_STACK_LINE(33)
	this->__f = f;
}
...
bool FileInput_obj::eof( ){
	HX_STACK_PUSH("FileInput::eof","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",73);
	HX_STACK_THIS(this);
	HX_STACK_LINE(73)
...
int FileInput_obj::tell( ){
	HX_STACK_PUSH("FileInput::tell","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("FileInput::seek","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",64);
		HX_STACK_THIS(this);
		HX_STACK_ARG(p,"p");
...
{
		HX_STACK_PUSH("FileInput::close","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",59);
		HX_STACK_THIS(this);
		HX_STACK_LINE(60)
		this->super::close();
		HX_STACK_LINE(61)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_PUSH("FileInput::readBytes","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",48);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(p,"p");
	HX_STACK_ARG(l,"l");
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileInput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",49);
			{
				HX_STACK_LINE(49)
				try{
					HX_STACK_LINE(49)
...
int FileInput_obj::readByte( ){
	HX_STACK_PUSH("FileInput::readByte","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",37);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileInput_obj *__this){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",38);
			{
				HX_STACK_LINE(38)
				try{
					HX_STACK_LINE(38)
