...
{
		HX_STACK_PUSH("Output::writeString","/usr/lib/haxe/std/haxe/io/Output.hx",348);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(352)
...
{
		HX_STACK_PUSH("Output::writeInput","/usr/lib/haxe/std/haxe/io/Output.hx",326);
		HX_STACK_THIS(this);
		HX_STACK_ARG(i,"i");
...
{
		HX_STACK_PUSH("Output::prepare","/usr/lib/haxe/std/haxe/io/Output.hx",323);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Output::writeInt32","/usr/lib/haxe/std/haxe/io/Output.hx",303);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(303)
		if ((this->bigEndian)){
...
{
		HX_STACK_PUSH("Output::writeUInt30","/usr/lib/haxe/std/haxe/io/Output.hx",288);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(289)
...
{
		HX_STACK_PUSH("Output::writeInt31","/usr/lib/haxe/std/haxe/io/Output.hx",271);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(273)
...
{
		HX_STACK_PUSH("Output::writeUInt24","/usr/lib/haxe/std/haxe/io/Output.hx",258);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(259)
...
{
		HX_STACK_PUSH("Output::writeInt24","/usr/lib/haxe/std/haxe/io/Output.hx",253);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(254)
...
{
		HX_STACK_PUSH("Output::writeUInt16","/usr/lib/haxe/std/haxe/io/Output.hx",242);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(243)
...
{
		HX_STACK_PUSH("Output::writeInt16","/usr/lib/haxe/std/haxe/io/Output.hx",237);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(238)
...
{
		HX_STACK_PUSH("Output::writeInt8","/usr/lib/haxe/std/haxe/io/Output.hx",231);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(232)
...
{
		HX_STACK_PUSH("Output::writeDouble","/usr/lib/haxe/std/haxe/io/Output.hx",154);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(154)
...
{
		HX_STACK_PUSH("Output::writeFloat","/usr/lib/haxe/std/haxe/io/Output.hx",100);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("Output::writeFullBytes","/usr/lib/haxe/std/haxe/io/Output.hx",92);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
{
		HX_STACK_PUSH("Output::write","/usr/lib/haxe/std/haxe/io/Output.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(82)
...
bool Output_obj::setEndian( bool b){
	HX_STACK_PUSH("Output::setEndian","/usr/lib/haxe/std/haxe/io/Output.hx",74);
	HX_STACK_THIS(this);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(75)
	this->bigEndian = b;
...
{
		HX_STACK_PUSH("Output::close","/usr/lib/haxe/std/haxe/io/Output.hx",71);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("Output::flush","/usr/lib/haxe/std/haxe/io/Output.hx",68);
		HX_STACK_THIS(this);
	}
return null();
}
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_PUSH("Output::writeBytes","/usr/lib/haxe/std/haxe/io/Output.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
...
{
		HX_STACK_PUSH("Output::writeByte","/usr/lib/haxe/std/haxe/io/Output.hx",41);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(41)
