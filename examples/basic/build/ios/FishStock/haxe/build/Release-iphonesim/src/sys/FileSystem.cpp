...
bool FileSystem_obj::exists( ::String path){
	HX_STACK_PUSH("FileSystem::exists","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",36);
...
{
		HX_STACK_PUSH("FileSystem::rename","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",40);
		HX_STACK_ARG(path,"path");
...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_PUSH("FileSystem::stat","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",45);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(46)
	...
	if (((s == null()))){
		struct _Function_2_1{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",48);
				{
...
::String FileSystem_obj::fullPath( ::String relpath){
	HX_STACK_PUSH("FileSystem::fullPath","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",55);
...
::sys::_FileSystem::FileKind FileSystem_obj::kind( ::String path){
	HX_STACK_PUSH("FileSystem::kind","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",59);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(60)
	::String k = ::sys::FileSystem_obj::sys_file_type(path);		HX_STACK_VAR(k,"k");
	struct _Function_1_1{
		inline static ::sys::_FileSystem::FileKind Block( ::String &k){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",61);
			{
				HX_STACK_LINE(61)
				::String _switch_1 = (k);
...
bool FileSystem_obj::isDirectory( ::String path){
	HX_STACK_PUSH("FileSystem::isDirectory","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",68);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("FileSystem::createDirectory","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",72);
		HX_STACK_ARG(path,"path");
		HX_STACK_LINE(72)
...
{
		HX_STACK_PUSH("FileSystem::deleteFile","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",77);
		HX_STACK_ARG(path,"path");
		HX_STACK_LINE(77)
...
{
		HX_STACK_PUSH("FileSystem::deleteDirectory","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",82);
		HX_STACK_ARG(path,"path");
		HX_STACK_LINE(82)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	HX_STACK_PUSH("FileSystem::readDirectory","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",87);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(87)
