...
Void Lib_obj::close( ){
{
		HX_STACK_PUSH("Lib::close","nme/Lib.hx",36);
		HX_STACK_LINE(36)
		::neash::Lib_obj::close();
	}
return null();
...
::String title = __o_title.Default(HX_CSTRING("NME"));
	HX_STACK_PUSH("Lib::create","nme/Lib.hx",59);
...
::neash::display::ManagedStage Lib_obj::createManagedStage( int width,int height){
	HX_STACK_PUSH("Lib::createManagedStage","nme/Lib.hx",75);
	HX_STACK_ARG(width,"width");
	HX_STACK_ARG(height,"height");
	HX_STACK_LINE(78)
	return ::neash::Lib_obj::createManagedStage(width,height);
	HX_STACK_LINE(80)
	return null();
}
...
Void Lib_obj::exit( ){
{
		HX_STACK_PUSH("Lib::exit","nme/Lib.hx",91);
		HX_STACK_LINE(91)
		::neash::Lib_obj::exit();
	}
return null();
...
{
		HX_STACK_PUSH("Lib::forceClose","nme/Lib.hx",105);
		HX_STACK_LINE(105)
...
int Lib_obj::getTimer( ){
	HX_STACK_PUSH("Lib::getTimer","nme/Lib.hx",123);
	HX_STACK_LINE(123)
...
{
		HX_STACK_PUSH("Lib::getURL","nme/Lib.hx",142);
...
Void Lib_obj::pause( ){
{
		HX_STACK_PUSH("Lib::pause","nme/Lib.hx",161);
		HX_STACK_LINE(161)
		::neash::Lib_obj::pause();
	}
return null();
...
{
		HX_STACK_PUSH("Lib::postUICallback","nme/Lib.hx",179);
...
Void Lib_obj::resume( ){
{
		HX_STACK_PUSH("Lib::resume","nme/Lib.hx",196);
		HX_STACK_LINE(196)
		::neash::Lib_obj::pause();
	}
return null();
...
{
		HX_STACK_PUSH("Lib::setPackage","nme/Lib.hx",215);
...
{
		HX_STACK_PUSH("Lib::trace","nme/Lib.hx",228);
		HX_STACK_ARG(arg,"arg");
		HX_STACK_LINE(228)
		::haxe::Log_obj::trace(arg,hx::SourceInfo(HX_CSTRING("Lib.hx"),231,HX_CSTRING("nme.Lib"),HX_CSTRING("trace")));
	}
return null();
}
...
::String Lib_obj::nmeGetCompany( ){
	HX_STACK_PUSH("Lib::nmeGetCompany","nme/Lib.hx",247);
	HX_STACK_LINE(250)
...
::neash::display::MovieClip Lib_obj::nmeGetCurrent( ){
	HX_STACK_PUSH("Lib::nmeGetCurrent","nme/Lib.hx",257);
	HX_STACK_LINE(257)
...
::String Lib_obj::nmeGetFile( ){
	HX_STACK_PUSH("Lib::nmeGetFile","nme/Lib.hx",271);
	HX_STACK_LINE(274)
...
int Lib_obj::nmeGetInitHeight( ){
	HX_STACK_PUSH("Lib::nmeGetInitHeight","nme/Lib.hx",281);
	HX_STACK_LINE(284)
...
int Lib_obj::nmeGetInitWidth( ){
	HX_STACK_PUSH("Lib::nmeGetInitWidth","nme/Lib.hx",291);
	HX_STACK_LINE(294)
...
::String Lib_obj::nmeGetPackageName( ){
	HX_STACK_PUSH("Lib::nmeGetPackageName","nme/Lib.hx",301);
	HX_STACK_LINE(304)
...
::neash::display::Stage Lib_obj::nmeGetStage( ){
	HX_STACK_PUSH("Lib::nmeGetStage","nme/Lib.hx",311);
	HX_STACK_LINE(311)
...
::String Lib_obj::nmeGetVersion( ){
	HX_STACK_PUSH("Lib::nmeGetVersion","nme/Lib.hx",323);
	HX_STACK_LINE(326)
