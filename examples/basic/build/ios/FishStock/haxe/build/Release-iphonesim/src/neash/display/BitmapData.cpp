...
bool BitmapData_obj::nmeGetTransparent( ){
	HX_STACK_PUSH("BitmapData::nmeGetTransparent","neash/display/BitmapData.hx",448);
	HX_STACK_THIS(this);
	HX_STACK_LINE(448)
...
int BitmapData_obj::nmeGetHeight( ){
	HX_STACK_PUSH("BitmapData::nmeGetHeight","neash/display/BitmapData.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_LINE(447)
...
int BitmapData_obj::nmeGetWidth( ){
	HX_STACK_PUSH("BitmapData::nmeGetWidth","neash/display/BitmapData.hx",446);
	HX_STACK_THIS(this);
	HX_STACK_LINE(446)
...
::neash::geom::Rectangle BitmapData_obj::nmeGetRect( ){
	HX_STACK_PUSH("BitmapData::nmeGetRect","neash/display/BitmapData.hx",445);
	HX_STACK_THIS(this);
	HX_STACK_LINE(445)
...
{
		HX_STACK_PUSH("BitmapData::setFormat","neash/display/BitmapData.hx",437);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::unlock","neash/display/BitmapData.hx",432);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setVector","neash/display/BitmapData.hx",415);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixels","neash/display/BitmapData.hx",406);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
...
{
		HX_STACK_PUSH("BitmapData::setPixel32","neash/display/BitmapData.hx",396);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixel","neash/display/BitmapData.hx",390);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inColour,"inColour");
...
{
		HX_STACK_PUSH("BitmapData::setFlags","neash/display/BitmapData.hx",383);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::scroll","neash/display/BitmapData.hx",377);
		HX_STACK_THIS(this);
