...
::String File_obj::getContent( ::String path){
	HX_STACK_PUSH("File::getContent","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",30);
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_PUSH("File::getBytes","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",35);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("File::saveContent","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",40);
		HX_STACK_ARG(path,"path");
...
{
		HX_STACK_PUSH("File::saveBytes","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",46);
		HX_STACK_ARG(path,"path");
...
bool binary = __o_binary.Default(true);
	HX_STACK_PUSH("File::read","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",52);
	HX_STACK_ARG(path,"path");
...
bool binary = __o_binary.Default(true);
	HX_STACK_PUSH("File::write","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",56);
	HX_STACK_ARG(path,"path");
	HX_STACK_ARG(binary,"binary");
{
		HX_STACK_LINE(56)
...
bool binary = __o_binary.Default(true);
	HX_STACK_PUSH("File::append","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",60);
	HX_STACK_ARG(path,"path");
	HX_STACK_ARG(binary,"binary");
{
		HX_STACK_LINE(60)
...
{
		HX_STACK_PUSH("File::copy","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",64);
