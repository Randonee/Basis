...
{
HX_STACK_PUSH("Tilesheet::new","neash/display/Tilesheet.hx",26);
{
	HX_STACK_LINE(27)
...
Void Tilesheet_obj::drawTiles( ::neash::display::Graphics graphics,Array< Float > tileData,hx::Null< bool >  __o_smooth,hx::Null< int >  __o_flags){
bool smooth = __o_smooth.Default(false);
int flags = __o_flags.Default(0);
	HX_STACK_PUSH("Tilesheet::drawTiles","neash/display/Tilesheet.hx",58);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Tilesheet::addTileRect","neash/display/Tilesheet.hx",33);
		HX_STACK_THIS(this);
...
void Tilesheet_obj::__boot()
{
	...
	nme_tilesheet_create= ::neash::Loader_obj::load(HX_CSTRING("nme_tilesheet_create"),(int)1);
	nme_tilesheet_add_rect= ::neash::Loader_obj::load(HX_CSTRING("nme_tilesheet_add_rect"),(int)3);
}
