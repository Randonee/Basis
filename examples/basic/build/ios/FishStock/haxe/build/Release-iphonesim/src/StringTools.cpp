...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_PUSH("StringTools::urlEncode","/usr/lib/haxe/std/StringTools.hx",41);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(41)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_PUSH("StringTools::urlDecode","/usr/lib/haxe/std/StringTools.hx",68);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(68)
...
::String StringTools_obj::htmlEscape( ::String s){
	HX_STACK_PUSH("StringTools::htmlEscape","/usr/lib/haxe/std/StringTools.hx",95);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(95)
...
::String StringTools_obj::htmlUnescape( ::String s){
	HX_STACK_PUSH("StringTools::htmlUnescape","/usr/lib/haxe/std/StringTools.hx",102);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(102)
	return s.split(HX_CSTRING("&gt;"))->join(HX_CSTRING(">")).split(HX_CSTRING("&lt;"))->join(HX_CSTRING("<")).split(HX_CSTRING("&amp;"))->join(HX_CSTRING("&"));
}
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_PUSH("StringTools::startsWith","/usr/lib/haxe/std/StringTools.hx",113);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_PUSH("StringTools::endsWith","/usr/lib/haxe/std/StringTools.hx",126);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_PUSH("StringTools::isSpace","/usr/lib/haxe/std/StringTools.hx",141);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_PUSH("StringTools::ltrim","/usr/lib/haxe/std/StringTools.hx",149);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(155)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_PUSH("StringTools::rtrim","/usr/lib/haxe/std/StringTools.hx",170);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(176)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(177)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_PUSH("StringTools::trim","/usr/lib/haxe/std/StringTools.hx",192);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(192)
...
::String StringTools_obj::rpad( ::String s,::String c,int l){
	HX_STACK_PUSH("StringTools::rpad","/usr/lib/haxe/std/StringTools.hx",207);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(c,"c");
	HX_STACK_ARG(l,"l");
	HX_STACK_LINE(211)
...
::String StringTools_obj::lpad( ::String s,::String c,int l){
	HX_STACK_PUSH("StringTools::lpad","/usr/lib/haxe/std/StringTools.hx",229);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(c,"c");
	HX_STACK_ARG(l,"l");
	HX_STACK_LINE(233)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_PUSH("StringTools::replace","/usr/lib/haxe/std/StringTools.hx",254);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_PUSH("StringTools::hex","/usr/lib/haxe/std/StringTools.hx",269);
	HX_STACK_ARG(n,"n");
...
int StringTools_obj::fastCodeAt( ::String s,int index){
	HX_STACK_PUSH("StringTools::fastCodeAt","/usr/lib/haxe/std/StringTools.hx",292);
	HX_STACK_ARG(s,"s");
...
bool StringTools_obj::isEOF( int c){
	HX_STACK_PUSH("StringTools::isEOF","/usr/lib/haxe/std/StringTools.hx",322);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(322)
	return (c == (int)0);
}
