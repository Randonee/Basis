...
bool DisplayObjectContainer_obj::nmeSetTabChildren( bool inValue){
	HX_STACK_PUSH("DisplayObjectContainer::nmeSetTabChildren","neash/display/DisplayObjectContainer.hx",353);
	HX_STACK_THIS(this);
...
bool DisplayObjectContainer_obj::nmeGetTabChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::nmeGetTabChildren","neash/display/DisplayObjectContainer.hx",352);
	HX_STACK_THIS(this);
	HX_STACK_LINE(352)
	return false;
}
...
int DisplayObjectContainer_obj::nmeGetNumChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::nmeGetNumChildren","neash/display/DisplayObjectContainer.hx",351);
	HX_STACK_THIS(this);
	HX_STACK_LINE(351)
...
bool DisplayObjectContainer_obj::nmeSetMouseChildren( bool inVal){
	HX_STACK_PUSH("DisplayObjectContainer::nmeSetMouseChildren","neash/display/DisplayObjectContainer.hx",345);
	HX_STACK_THIS(this);
...
bool DisplayObjectContainer_obj::nmeGetMouseChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::nmeGetMouseChildren","neash/display/DisplayObjectContainer.hx",343);
	HX_STACK_THIS(this);
	HX_STACK_LINE(343)
...
{
		HX_STACK_PUSH("DisplayObjectContainer::swapChildrenAt","neash/display/DisplayObjectContainer.hx",333);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::swapChildren","neash/display/DisplayObjectContainer.hx",323);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::setChildIndex","neash/display/DisplayObjectContainer.hx",317);
		HX_STACK_THIS(this);
...
::neash::display::DisplayObject DisplayObjectContainer_obj::removeChildAt( int index){
	HX_STACK_PUSH("DisplayObjectContainer::removeChildAt","neash/display/DisplayObjectContainer.hx",304);
	HX_STACK_THIS(this);
	HX_STACK_ARG(index,"index");
	HX_STACK_LINE(305)
