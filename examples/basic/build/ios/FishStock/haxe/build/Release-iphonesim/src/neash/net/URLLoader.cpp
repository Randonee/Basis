...
{
HX_STACK_PUSH("URLLoader::new","neash/net/URLLoader.hx",51);
{
	HX_STACK_LINE(52)
...
{
		HX_STACK_PUSH("URLLoader::update","neash/net/URLLoader.hx",171);
		HX_STACK_THIS(this);
		HX_STACK_LINE(171)
...
{
		HX_STACK_PUSH("URLLoader::dispatchHTTPStatus","neash/net/URLLoader.hx",166);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("URLLoader::onError","neash/net/URLLoader.hx",161);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("URLLoader::nmeDataComplete","neash/net/URLLoader.hx",121);
		HX_STACK_THIS(this);
		HX_STACK_LINE(122)
		::neash::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(123)
...
{
		HX_STACK_PUSH("URLLoader::load","neash/net/URLLoader.hx",82);
		HX_STACK_THIS(this);
...
Array< ::String > URLLoader_obj::getCookies( ){
	HX_STACK_PUSH("URLLoader::getCookies","neash/net/URLLoader.hx",67);
	HX_STACK_THIS(this);
	HX_STACK_LINE(67)
...
{
		HX_STACK_PUSH("URLLoader::close","neash/net/URLLoader.hx",63);
		HX_STACK_THIS(this);
	}
return null();
}
...
bool URLLoader_obj::hasActive( ){
	HX_STACK_PUSH("URLLoader::hasActive","neash/net/URLLoader.hx",72);
	HX_STACK_LINE(72)
...
{
		HX_STACK_PUSH("URLLoader::initialize","neash/net/URLLoader.hx",77);
...
bool URLLoader_obj::nmeLoadPending( ){
	HX_STACK_PUSH("URLLoader::nmeLoadPending","neash/net/URLLoader.hx",139);
	HX_STACK_LINE(139)
	return !(::neash::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
{
		HX_STACK_PUSH("URLLoader::nmePollData","neash/net/URLLoader.hx",144);
		HX_STACK_LINE(144)
