...
{
HX_STACK_PUSH("List::new","/usr/lib/haxe/std/List.hx",44);
{
	HX_STACK_LINE(44)
	this->length = (int)0;
}
...
::List List_obj::map( Dynamic f){
	HX_STACK_PUSH("List::map","/usr/lib/haxe/std/List.hx",246);
	HX_STACK_THIS(this);
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(247)
...
::List List_obj::filter( Dynamic f){
	HX_STACK_PUSH("List::filter","/usr/lib/haxe/std/List.hx",230);
	HX_STACK_THIS(this);
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(231)
...
::String List_obj::join( ::String sep){
	HX_STACK_PUSH("List::join","/usr/lib/haxe/std/List.hx",211);
	HX_STACK_THIS(this);
...
::String List_obj::toString( ){
	HX_STACK_PUSH("List::toString","/usr/lib/haxe/std/List.hx",191);
	HX_STACK_THIS(this);
	HX_STACK_LINE(192)
	::StringBuf s = ::StringBuf_obj::__new();		HX_STACK_VAR(s,"s");
	HX_STACK_LINE(193)
...
Dynamic List_obj::iterator( ){
	HX_STACK_PUSH("List::iterator","/usr/lib/haxe/std/List.hx",152);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/List.hx",170);
			{
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_1","/usr/lib/haxe/std/List.hx",172);
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","/usr/lib/haxe/std/List.hx",175);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(177)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_PUSH("List::remove","/usr/lib/haxe/std/List.hx",129);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(130)
...
Void List_obj::clear( ){
{
		HX_STACK_PUSH("List::clear","/usr/lib/haxe/std/List.hx",119);
		HX_STACK_THIS(this);
		HX_STACK_LINE(120)
		this->h = null();
		HX_STACK_LINE(121)
...
bool List_obj::isEmpty( ){
	HX_STACK_PUSH("List::isEmpty","/usr/lib/haxe/std/List.hx",112);
	HX_STACK_THIS(this);
	HX_STACK_LINE(112)
	return (this->h == null());
}
...
Dynamic List_obj::pop( ){
	HX_STACK_PUSH("List::pop","/usr/lib/haxe/std/List.hx",98);
	HX_STACK_THIS(this);
	HX_STACK_LINE(99)
	if (((this->h == null()))){
		HX_STACK_LINE(100)
...
Dynamic List_obj::last( ){
	HX_STACK_PUSH("List::last","/usr/lib/haxe/std/List.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_LINE(88)
...
Dynamic List_obj::first( ){
	HX_STACK_PUSH("List::first","/usr/lib/haxe/std/List.hx",80);
	HX_STACK_THIS(this);
	HX_STACK_LINE(80)
...
{
		HX_STACK_PUSH("List::add","/usr/lib/haxe/std/List.hx",51);
		HX_STACK_THIS(this);
		HX_STACK_ARG(item,"item");
		HX_STACK_LINE(52)
