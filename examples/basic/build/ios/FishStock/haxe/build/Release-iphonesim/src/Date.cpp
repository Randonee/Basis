...
{
HX_STACK_PUSH("Date::new","/usr/lib/haxe/std/cpp/_std/Date.hx",31);
{
	HX_STACK_LINE(31)
...
::String Date_obj::toString( ){
	HX_STACK_PUSH("Date::toString","/usr/lib/haxe/std/cpp/_std/Date.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_LINE(53)
...
int Date_obj::getDay( ){
	HX_STACK_PUSH("Date::getDay","/usr/lib/haxe/std/cpp/_std/Date.hx",51);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
...
int Date_obj::getDate( ){
	HX_STACK_PUSH("Date::getDate","/usr/lib/haxe/std/cpp/_std/Date.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
...
int Date_obj::getMonth( ){
	HX_STACK_PUSH("Date::getMonth","/usr/lib/haxe/std/cpp/_std/Date.hx",47);
	HX_STACK_THIS(this);
	HX_STACK_LINE(47)
...
int Date_obj::getFullYear( ){
	HX_STACK_PUSH("Date::getFullYear","/usr/lib/haxe/std/cpp/_std/Date.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_LINE(45)
...
int Date_obj::getSeconds( ){
	HX_STACK_PUSH("Date::getSeconds","/usr/lib/haxe/std/cpp/_std/Date.hx",43);
	HX_STACK_THIS(this);
	HX_STACK_LINE(43)
...
int Date_obj::getMinutes( ){
	HX_STACK_PUSH("Date::getMinutes","/usr/lib/haxe/std/cpp/_std/Date.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_LINE(41)
...
int Date_obj::getHours( ){
	HX_STACK_PUSH("Date::getHours","/usr/lib/haxe/std/cpp/_std/Date.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
...
Float Date_obj::getTime( ){
	HX_STACK_PUSH("Date::getTime","/usr/lib/haxe/std/cpp/_std/Date.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_LINE(35)
...
::Date Date_obj::now( ){
	HX_STACK_PUSH("Date::now","/usr/lib/haxe/std/cpp/_std/Date.hx",55);
	HX_STACK_LINE(55)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_PUSH("Date::fromTime","/usr/lib/haxe/std/cpp/_std/Date.hx",59);
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(60)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_PUSH("Date::fromString","/usr/lib/haxe/std/cpp/_std/Date.hx",65);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(66)
	switch( (int)(s.length)){
		case (int)8: {
