...
{
HX_STACK_PUSH("FileOutput::new","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",33);
{
	HX_STACK_LINE(33)
	this->__f = f;
}
...
int FileOutput_obj::tell( ){
	HX_STACK_PUSH("FileOutput::tell","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",58);
	HX_STACK_THIS(this);
	HX_STACK_LINE(58)
...
{
		HX_STACK_PUSH("FileOutput::seek","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",54);
		HX_STACK_THIS(this);
		HX_STACK_ARG(p,"p");
...
{
		HX_STACK_PUSH("FileOutput::close","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",49);
		HX_STACK_THIS(this);
		HX_STACK_LINE(50)
		this->super::close();
		HX_STACK_LINE(51)
...
{
		HX_STACK_PUSH("FileOutput::flush","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",45);
		HX_STACK_THIS(this);
		HX_STACK_LINE(45)
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_PUSH("FileOutput::writeBytes","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(p,"p");
	HX_STACK_ARG(l,"l");
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileOutput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",42);
			{
				HX_STACK_LINE(42)
				try{
					HX_STACK_LINE(42)
...
{
		HX_STACK_PUSH("FileOutput::writeByte","/usr/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",37);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(37)
		try{
