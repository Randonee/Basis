...
{
HX_STACK_PUSH("Hash::new","/usr/lib/haxe/std/cpp/_std/Hash.hx",29);
{
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/Hash.hx",30);
			{
...
::String Hash_obj::toString( ){
	HX_STACK_PUSH("Hash::toString","/usr/lib/haxe/std/cpp/_std/Hash.hx",76);
	HX_STACK_THIS(this);
	HX_STACK_LINE(77)
...
Dynamic Hash_obj::iterator( ){
	HX_STACK_PUSH("Hash::iterator","/usr/lib/haxe/std/cpp/_std/Hash.hx",61);
	HX_STACK_THIS(this);
	HX_STACK_LINE(62)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it,Array< ::Hash > &me){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/Hash.hx",66);
			{
				hx::Anon __result = hx::Anon_obj::Create();

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Dynamic,it)
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","/usr/lib/haxe/std/cpp/_std/Hash.hx",67);
					{
						HX_STACK_LINE(67)
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","/usr/lib/haxe/std/cpp/_std/Hash.hx",68);
					{
						HX_STACK_LINE(68)
...
Dynamic Hash_obj::keys( ){
	HX_STACK_PUSH("Hash::keys","/usr/lib/haxe/std/cpp/_std/Hash.hx",52);
	HX_STACK_THIS(this);
	HX_STACK_LINE(53)
	Array< ::String > a = Array_obj< ::String >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(54)
...
bool Hash_obj::remove( ::String key){
	HX_STACK_PUSH("Hash::remove","/usr/lib/haxe/std/cpp/_std/Hash.hx",45);
	HX_STACK_THIS(this);
...
bool Hash_obj::exists( ::String key){
	HX_STACK_PUSH("Hash::exists","/usr/lib/haxe/std/cpp/_std/Hash.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(41)
...
Dynamic Hash_obj::get( ::String key){
	HX_STACK_PUSH("Hash::get","/usr/lib/haxe/std/cpp/_std/Hash.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(37)
...
{
		HX_STACK_PUSH("Hash::set","/usr/lib/haxe/std/cpp/_std/Hash.hx",33);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
