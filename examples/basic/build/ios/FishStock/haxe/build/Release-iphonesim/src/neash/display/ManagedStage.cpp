...
{
HX_STACK_PUSH("ManagedStage::new","neash/display/ManagedStage.hx",42);
{
	HX_STACK_LINE(42)
...
{
		HX_STACK_PUSH("ManagedStage::setNextWake","neash/display/ManagedStage.hx",100);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ManagedStage::sendQuit","neash/display/ManagedStage.hx",94);
		HX_STACK_THIS(this);
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","neash/display/ManagedStage.hx",95);
				{
...
{
		HX_STACK_PUSH("ManagedStage::resize","neash/display/ManagedStage.hx",88);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inWidth,"inWidth");
		HX_STACK_ARG(inHeight,"inHeight");
		struct _Function_1_1{
			inline static Dynamic Block( int &inWidth,int &inHeight){
				HX_STACK_PUSH("*::closure","neash/display/ManagedStage.hx",89);
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_PUSH("ManagedStage::pumpEvent","neash/display/ManagedStage.hx",82);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ManagedStage::nmeRender","neash/display/ManagedStage.hx",74);
		HX_STACK_THIS(this);
...
Float ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	HX_STACK_PUSH("ManagedStage::nmeDoProcessStageEvent","neash/display/ManagedStage.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inEvent,"inEvent");
	HX_STACK_LINE(61)
	this->nmePollTimers();
...
Void run(){
{
		HX_STACK_PUSH("ManagedStage::endRender","neash/display/ManagedStage.hx",54);
		HX_STACK_THIS(this);
	}
return null();
}
...
Void run(){
{
		HX_STACK_PUSH("ManagedStage::beginRender","neash/display/ManagedStage.hx",48);
		HX_STACK_THIS(this);
	}
return null();
}
...
void ManagedStage_obj::__boot()
{
	...
	nme_managed_stage_create= ::neash::Loader_obj::load(HX_CSTRING("nme_managed_stage_create"),(int)2);
	nme_managed_stage_pump_event= ::neash::Loader_obj::load(HX_CSTRING("nme_managed_stage_pump_event"),(int)2);
}
